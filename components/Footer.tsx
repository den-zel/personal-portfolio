...
const Footer = () => {
  return (
    <footer className='py-10 border-t border-peach max-width'>
      ...
      {/* contact details */}
      <div className='w-max border border-peach mt-2 p-5 mx-auto flex gap-5 tablet:gap-10 flex-col tablet:flex-row items-center rounded-lg hover:font-medium hover:text-black'>
        {contactDetails.map((detail, index) => (
          <div key={index} className='flex gap-3 items-center text-blue'>
            {detail.icon && <detail.icon size={20} />}
